...
If you're logging inference calls to Athina, you can update the logs with additional information or any missing data. You can do this by sending a patch request with `prompt_run_id` as the original inference log.
