...
For grounded evals like [Answer Similarity](/evals/preset_evals/answer_similarity), you must also log a reference response (string) to compare against:
...
We extract tool_calls from the openai completion response and log it in our database
