...
<Tabs items={["Python Wrapper (Recommended)", "Python (Streaming)", "Python (Manual)", "API Request"]}>
  ...
  <Tabs.Tab>
    ...
    ##### 4. Collect the streaming responses
  ...
  <Tabs.Tab>
    ...
    try:
        InferenceLogger.log_open_ai_chat_response(
            ...
            prompt_slug="generate_email_v1", # OPTIONAL, identifier for the prompt / version; default value: default
