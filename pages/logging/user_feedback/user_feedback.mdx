...
def user_feedback_test():
    try:
        user_feedback.UserFeedback.log_user_feedback(
            ...
            user_feedback=1,
            user_feedback_comment="test" # OPTIONAL
        )
...
**Endpoint**: `https://api.athina.ai/api/v1/promptRun/user-feedback`
...
```json
{
  "external_reference_id": "bhv",
  "user_feedback": 1,
  "user_feedback_comment": "this is a user feedback"
}
```
