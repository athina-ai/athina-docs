...
### Postman Collection
You can find <a href="/GraphQL.postman_collection.json" download><mark>here</mark></a> an entire postman collection with different types of queries for reference. You can download the collection and import it into your postman application.
## Python
