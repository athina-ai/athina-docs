...
The same can be done using any other language that supports HTTP requests and JSON parsing. You can find an example using Node.js towards the end for reference of the same.
...
### Postman Collection
You can find <a href="/GraphQL_API.postman_collection.json" download><mark>here</mark></a> an entire postman collection with different types of queries for reference. You can download the collection and import it into your postman application.
## Python
