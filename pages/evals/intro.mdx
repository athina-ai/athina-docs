...
- measuring performance of model (as defined by your goals)
- A/B testing different models and prompts rapidly
- Monitor production data with confidence
- Turn ambiguous conversations into quantifiable experiments (\*)
