...
A function evaluator runs a provided function along with the arguements for this function on the response and return whether the function passed or not.
